...
public class MemberVO {
	private String id,fname,sname,pwd,sex,birthday,email,post,addr1,addr2,phone,content,name,check_vue,phonePrefix,check_id,emailPrefix,state,sdata,mday,bday,lday;
