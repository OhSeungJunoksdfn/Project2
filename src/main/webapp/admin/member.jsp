...
const userListApp=Vue.createApp({
	...
	methods:{
		memberActivate(id){
			axios.post("../admin/member_Activate.do",null,{
				params:{
					id:id
				}
			})
		...
		memberSuspended(id){
			axios.post("../admin/member_Suspended.do",null,{
				params:{
					id:id
				}
			})
			...
			adminMembememberDetailData(i){
			axios.get("../admin/member_detail_vue.do",{
				params:{
					no:i
				}
			})
		...
		renderData(){
			axios.get("../admin/user_list_vue.do",{
				params:{
					page:this.page,
				}
			})
