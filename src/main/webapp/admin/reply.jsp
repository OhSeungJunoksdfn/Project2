...
<body>
<section class="w-100" id="replyListApp">
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="(vo,key) in list" :key="key">
              ...
              <td width="40%">
                <a @click="replyDetailData(vo.msg)" class="cursor-pointer" style="font-weight:700;color:black;overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                  {{vo.msg }}
                </a>
              </td>
